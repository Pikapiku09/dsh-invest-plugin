...
const CHECKLIST = [
  ...
  '在输出任何「建议买入 / 可买入 / 建议加仓」结论之前，你必须先输出完整的【开仓强制Checklist】。任一项目为「拒绝」，最终结论必须为「拒绝买入 / 拒绝加仓」并说明原因。禁止跳步：没有输出完整 Checklist 的买入建议一律视为无效输出。',
  '【开仓强制Checklist 输出格式】',
...
export { DATA_BASE, CHECKLIST, P_SELECT, P_NEWS, P_DEEP, P_FINAL }
